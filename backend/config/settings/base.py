...
SHARED_APPS = [
    'django_tenants',  # mandatory, should come first
    'apps.core.apps.CoreConfig',       # shared models
    'apps.auth.apps.AuthConfig',       # authentication
